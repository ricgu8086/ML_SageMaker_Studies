...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim', type=int, help='dimension of input data')
    parser.add_argument('--hidden_dim', type=int, help='dimension of the hidden layers')
    parser.add_argument('--output_dim', type=int, help='dimension of output layer')
